...
// duplicated in Admin-RollupEventSales, Transaction-EmailReceipt) --
...
// project-wide (see this file's own `totalSales += item.total + item.discount` add-back, and
// `tips` accumulated independently) -- so neither needs subtracting here.
//
